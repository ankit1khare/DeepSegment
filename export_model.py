...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    semantic_predictions = tf.slice(
        ...
        [0, 0, 0, 0],  # [0, 0, 0],
        [1, resized_image_size[0], resized_image_size[1], FLAGS.num_classes])  #  [1, resized_image_size[0], resized_image_size[1]]
    ...
    def _resize_label(label, label_size):
      ...
      resized_label = tf.image.resize_images(
          ...
          align_corners=True)
      return resized_label  # tf.cast(tf.squeeze(resized_label, 3), tf.int32)
